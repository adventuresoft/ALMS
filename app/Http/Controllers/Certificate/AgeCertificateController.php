...
class AgeCertificateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $result = DB::transaction(function () use ($request) {
            ...
            $certificate = new AgeCertificate();
            ...
            try {
                ...
                // $data['redirect_url'] = route('age.show', $certificate->id);
                return $data;
            } catch (\Throwable $th) {
                $data['status'] = false;
     ...
     *
     * @param  \App\Models\Certificate\AgeCertificate  $ageCertificate
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        $data['certificate'] = AgeCertificate::with(array('user' => function($q1){
        ...
        // return view('backend.pages.certificate.age.certificate', $data);
        $html = view('backend.pages.certificate.age.certificate', $data)->render();
        ...
        return $pdf->stream('age-certificate.pdf');
    ...
    public function bn_certificate($id){
        ...
        return view('backend.pages.certificate.age.bn_certificate', $data);
        $html = view('backend.pages.certificate.age.certificate', $data)->render();
        $pdf = PDF::loadHTML($html)->setPaper('a4', 'landscape')
        ->setOptions([
            'defaultFont' => 'sans-serif',
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AgeCertificate $ageCertificate)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, AgeCertificate $ageCertificate)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(AgeCertificate $ageCertificate)
    {
        //
    }
}
