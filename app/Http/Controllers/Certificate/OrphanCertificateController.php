...
class OrphanCertificateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $result = DB::transaction(function () use ($request) {
            ...
            $certificate = new OrphanCertificate();
            ...
            try {
                ...
                $data['code'] = 200;
                $data['redirect_url'] = route('orphan.index');
                // $data['redirect_url'] = route('orphan.show', $certificate->id);
     ...
     *
     * @param  \App\Models\Certificate\OrphanCertificate  $orphanCertificate
     * @return \Illuminate\Http\Response
     */
    public function show( $id)
    {
        $data['certificate'] = OrphanCertificate::with(array('user' => function($q1){
        ...
        // return view('backend.pages.certificate.orphan.show', $data);
        $html = view('backend.pages.certificate.orphan.certificate', $data)->render();
        ...
        return $pdf->stream('orphan-certificate.pdf');
    }
    public function bn_certificate($id){
        ...
        return view('backend.pages.certificate.orphan.bn_certificate', $data);
        $html = view('backend.pages.certificate.orphan.certificate', $data)->render();
        $pdf = PDF::loadHTML($html)->setPaper('a4', 'landscape')
        ->setOptions([
            'defaultFont' => 'sans-serif',
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(OrphanCertificate $orphanCertificate)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, OrphanCertificate $orphanCertificate)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(OrphanCertificate $orphanCertificate)
    {
        //
    }
}
