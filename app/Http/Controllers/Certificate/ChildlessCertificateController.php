...
class ChildlessCertificateController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $result = DB::transaction(function () use ($request) {
            ...
            $certificate = new ChildlessCertificate();
            ...
            try {
                ...
                $data['code'] = 200;
                $data['redirect_url'] = route('childless.index');
                // $data['redirect_url'] = route('childless.show', $certificate->id);
                return $data;
            } catch (\Throwable $th) {
                $data['status'] = false;
     ...
     *
     * @param  \App\Models\Certificate\ChildlessCertificate  $childlessCertificate
     * @return \Illuminate\Http\Response
     */
    public function show($id)
    {
        $data['certificate'] = ChildlessCertificate::with(array('user' => function($q1){
        ...
        return view('backend.pages.certificate.childless.show', $data);
        $html = view('backend.pages.certificate.childless.certificate', $data)->render();
        ...
        return $pdf->stream('childless-certificate.pdf');
    ...
    public function bn_certificate($id){
        ...
        // return response()->json($data, 200);
        return view('backend.pages.certificate.childless.bn_certificate', $data);
        $html = view('backend.pages.certificate.childless.certificate', $data)->render();
        $pdf = PDF::loadHTML($html)->setPaper('a4', 'landscape')
        ->setOptions([
            'defaultFont' => 'sans-serif',
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ChildlessCertificate $childlessCertificate)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, ChildlessCertificate $childlessCertificate)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(ChildlessCertificate $childlessCertificate)
    {
        //
    }
}
