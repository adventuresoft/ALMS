@extends('backend.master', ['mainMenu' => 'AccessManagment', 'subMenu' => 'bankuser'])
@section('content')
    ...
    <div class="" style="min-height: 1203.6px;">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Bank User Mapping</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Bank User</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <form role="form" method="POST"
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button type="reset" class="btn btn-warning ml-2"><i class="fa fa-undo-alt"></i>
                                            Reset</button>
                                        <a href="{{ route('bankuser.index') }}" class="btn btn-dark ml-2"><i
                                                class="fa fa-arrow-left"></i> Back</a>
                                    </div>
                                </form>
                            @else
                                <!-- Create Form -->
                                <form role="form" method="POST" action="{{ route('bankuser.store') }}">
                                    @csrf
                                    ...
                                    <div class="card-body">
                                        ...
                                        <!-- Bank -->
                                        <div class="form-group">
                                            <label for="new_bank_id">Bank</label>
                                            <select class="form-control select2-ajax" id="new_bank_id" name="bank_id" required
                                                data-url="{{ route('autocomplete.banks') }}">
                                            </select>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-header bg-info">
                                <h3 class="card-title">Bank User List</h3>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#new_bank_id').on('change',function(){
