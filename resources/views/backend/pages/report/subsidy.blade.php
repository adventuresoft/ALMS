@extends('backend.master', ['mainMenu' => 'Report', 'subMenu' => 'SubsidyReport'])
@push('style')
    <style>
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Subsidy Report</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('report.subsidy-report') }}">General report</a></li>
                    ...
                    <div class="card card-info">
                        <div class="card-header ">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h3 class="card-title">Subsidy Report</h3>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
