                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="loan_type" id="loan_type" class="form-control">
                                                ...
                                                @foreach (loanTypes() as $l_key=>$loan)
                                                    <option value="{{$l_key}}">{{$loan}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="loan_amount" class="form-control" name="loan_amount">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="total_payable" class="form-control" name="total_payable">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="ontime_payable_date">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="last_payable_date">Default Date</label>
                                            <input type="date" class="form-control" name="last_payable_date">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Guarantor Name" name="guarantor_name" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="guarantor_dob">Date of Birth</label>
                                            <input type="date" class="form-control" name="guarantor_dob" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="guarantor_nid">NID</label>
                                            <input type="text"  id="guarantor_nid" class="form-control" name="guarantor_nid" placeholder="NID" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="guarantor_mobile">Mobile</label>
                                            <input type="text" id="guarantor_mobile" class="form-control" placeholder="Mobile" name="guarantor_mobile" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Father Name" name="guarantor_father_name" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="guarantor_mother_name">Mother Name</label>
                                            <input type="text" class="form-control" placeholder="Mother Name" name="guarantor_mother_name" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="guarantor_profession">Profession</label>
                                            <input type="text" class="form-control" placeholder="Profession" name="guarantor_profession" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="guarantor_address">Address</label>
                                            <textarea id="guarantor_address" class="form-control" placeholder="Address" name="guarantor_address" rows="1"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
