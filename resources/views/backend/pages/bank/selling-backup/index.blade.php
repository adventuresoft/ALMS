@extends('backend.master', ['mainMenu' => 'BankSelling', 'subMenu' => 'BankSellingList'])
@push('style')
    <style>
...
@endpush
@section('title', 'Bank Selling List')
@section('content')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('bank-selling.index') }}">Bank Selling</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Bank Selling List</h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <table id="datatable" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @if (count($bank_sellings))
                                        @foreach ($bank_sellings as $key => $selling)
                                            <tr>
                                                <td>{{ ++$key }}</td>
                                                <td>{{ $selling->bank->en_name }}</td>
                                                <td>{{ $selling->branch->en_name }}</td>
                                                <td>{{ financialYears($selling->financial_year) }}</td>
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            $(".deleteBankSelling").submit(function(e) {
                e.preventDefault();
                var thisForm = $(this);
