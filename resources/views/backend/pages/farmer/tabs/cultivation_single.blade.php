<tr>
    <td>
        <select class="form-control" name="crop[]" style="min-width: 200px; height: 42px; font-size: 14px;">
    ...
    <td>
        <select class="form-control" name="land_owner[]" style="min-width: 180px; height: 42px; font-size: 14px;">
    ...
    <td><input type="text" class="form-control" style="height: 42px;" value="{{$cultivation->quantity ?? ''}}" name="quantity[]"></td>
    <td>
