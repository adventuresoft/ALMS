                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            @include('backend.pages.farmer.tabs.tab_header', ['user' => $user, 'active_tab' => 'personal'])
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        ...
                        <form class="form-horizontal" id="farmerPersonalForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="tel" required maxlength="11" value="{{ $user->mobile ?? '' }}" name="mobile"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" maxlength="17" value="{{ $user->birth_certificate ?? '' }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" maxlength="17" value="{{ $user->nid ?? '' }}" name="nid"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#farmerPersonalForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('farmer.update', $user->id) }}",
