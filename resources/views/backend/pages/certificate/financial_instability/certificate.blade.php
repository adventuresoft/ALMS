                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <h3 class="text-light bg-success bold">Financ i a l Instab i l i t y Certif i c a t e</h3>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <p>This is to certify that <strong
                                                ...
                                                Village: <strong
                                                    class="text-blue">{{ $certificate->user->addressInfo->permanentVillage->en_name ?? '' }}</strong>,
                                                <strong
                                                    class="text-blue">Road-{{ $certificate->user->addressInfo->permanent_road ?? '' }}</strong>,
