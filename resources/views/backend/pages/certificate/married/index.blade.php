                                ...
                                @if ($certificates)
                                    ...
                                    @foreach ($certificates as $key => $certificate)
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="{{route('married.show', $certificate->id)}}" class="btn btn-primary"><i class="fa fa-file-pdf"></i> EN</a>
                                                <a target="_blank" href="{{route('married.bn_certificate', $certificate->id)}}" class="btn btn-info"><i class="fa fa-file-pdf"></i> BN</a>
                                                {{-- @can('people-update')
