                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                  @if (create_permission())
                                    <a href="{{route('income.create')}}" class="btn btn-primary">Create</a>
                                  @endif
                                </div>
                                ...
                                @if ($certificates)
                                    ...
                                    @foreach ($certificates as $key => $certificate)
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="{{route('income.show', $certificate->id)}}" class="btn btn-primary"><i class="fa fa-file-pdf"></i> EN</a>
                                                <a target="_blank" href="{{route('income.bn_certificate', $certificate->id)}}" class="btn btn-info"><i class="fa fa-file-pdf"></i> BN</a>
                                                {{-- @can('people-update')
