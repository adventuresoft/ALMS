...
@section('content')
   ...
   <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Landless Certificate</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('landless.index')}}">Landless</a></li>
                                ...
                                @if ($certificates)
                                    ...
                                    @foreach ($certificates as $key => $certificate)
                                        <tr>
                                            ...
                                            <td>
                                                <a target="_blank" href="{{route('landless.show', $certificate->id)}}" class="btn btn-primary"><i class="fa fa-file-pdf"></i> EN</a>
                                                <a target="_blank" href="{{route('landless.bn_certificate', $certificate->id)}}" class="btn btn-info"><i class="fa fa-file-pdf"></i> BN</a>
                                                {{-- @can('people-update')
