      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('character.index')}}">Character</a></li>
                                    ...
                                    @if ($certificates)
                                        @foreach ($certificates as $key => $certificate)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('character.show', $certificate->id)}}" target="_blank" class="btn btn-primary"><i class="fa fa-file-pdf"></i> EN</a>
                                                     <a target="_blank" href="{{route('character.bn_certificate', $certificate->id)}}" class="btn btn-info"><i class="fa fa-file-pdf"></i> BN</a>
                                                    {{-- @can('people-update')
