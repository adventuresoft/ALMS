...
<div class="container">
  <div class="card mt-2"
  style="background-image: url({{ asset('images/bg-images.jpeg') }}); background-size: cover;">
          ...
          <div class="border border-5 border-info p-5">
              ...
              <div class="row mt-2">
                  <div class="col-md-2 col-2 text-right">
                      <img height="100" width="100" class="mx-auto d-block"
                          ...
                          alt="govt-bd-logo"> --}}
                          src="{{ asset('images/dhaka.png') }}" alt="govt-bd-logo">
                  </div>
                  <div class="col-md-8 col-8 text-center">
                      {{-- <h2 class="text-danger bold">{{ $certificate->user->institute->union->bn_name ?? '' }} --}}
                        <h2 class="text-success font-weight-bold mb-0">
                            ৩নং শুকতাইল ইউনিয়ন পরিষদ
                        </h2>
                      <h2 class="bold" style="color: #2e3192;">No. 3 Suktail Union Parishad</h2>
                      <p>
                  ...
                  <div class="col-md-2 col-2 text-left">
                      <img height="100" width="100" class="mx-auto d-block"
                          ...
                          alt="govt-bd-logo"> --}}
                          src="{{ asset('images/govt-bd-logo.png') }}" alt="govt-bd-logo">
                  </div>
              </div>
              <div class="row character-certificate mt-2">
                  ...
                  <div class="col-md-4 col-4 text-center">
                    <h3 class="text-light bg-info bold py-1 mb-0 rounded-pill">
                        নাগরিক সনদ
                    </h3>
                  </div>
              ...
              <div class="row mt-5">
                  ...
                  <div class="col-md-12 certificate-body">        
                    ...
                    <br>
                    <p class="ml-5">আমি তার সার্বিক কল্যাণ ও মঙ্গলময় উন্নত জীবন কামনা করি।</p>
                    <br>
                    <div class="d-flex justify-content-between mb-3">
                        <img height="100" width="100" class="d-block"
                                src="{{ asset('images/scanner.png') }}" alt="govt-bd-logo">
                        <p class="mr-5"> চেয়ারম্যান </p> 
                    </div>
                    
                  </div>
              </div>
              <div>
                <p class="mb-0">This report generated by UPMS || Power by: <a href="https://www.adventuresoft.com.bd">Adventure Soft</a></p>
            </div>
          </div>
  ...
  <div class="text-center">
        <button id="printPageButton" class="btn btn-outline-secondary btn-sm" onClick="window.print();">Print</button>
