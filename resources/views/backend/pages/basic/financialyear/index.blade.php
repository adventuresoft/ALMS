                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="{{ route('basic-settings.financial-year.create') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:10%">
                                                        <div class="table-action">
                                                            ...
                                                            @can('financial-year-update')
                                                                <a class="btn btn-sm btn-primary"
                                                                    title="Edit"
                                                                    data-toggle="tooltip"
                                                                    href="{{ route('basic-settings.financial-year.edit', $item->id) }}"
                                                                >
                                                            ...
                                                            <a class="btn btn-sm btn-info"
                                                                title="Show"
                                                                data-toggle="tooltip"
                                                                href="{{ route('basic-settings.financial-year.show', $item->id) }}">
                                                                <i class="fa fa-eye"></i>
                                                            </a>

                                                            @can('financial-year-delete')
                                                                <form class="deleteType" method="post">
                                                                    ...
                                                                    <input type="hidden" class="deleteUrl" name="deleteUrl"
                                                                        value="{{ route('basic-settings.financial-year.destroy', $item->id) }}">
                                                                    <button type="submit"
                                                                        title="Delete"
                                                                        data-toggle="tooltip"
