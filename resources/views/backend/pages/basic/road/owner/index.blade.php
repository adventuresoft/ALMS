@extends('backend.master', ['mainMenu' => 'Basic', 'subMenu' =>'RoadOwner'])
@push('style')
@endpush
@section('title', 'Road Owner ')
@section('content')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('basic-settings.road-owner.index')}}">Road Owner </a></li>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a href="{{route('basic-settings.road-owner.create')}}" class="btn btn-primary">Create</a>
                                </div>
...
<script>
  ...
  $(document).ready(function(){
    $(".deleteOwner").on('submit', function(e){
      e.preventDefault();
      var thisForm = $(this);
			...
			onShown: function (toast) {
				$("#confirmationRevertYes").click(function(){
                    ...
                    success: function (response) {
                        ...
                        setTimeout(function() {
                            location.href = "{{route('basic-settings.road-owner.index')}}";
                        }, 2000)
                    },
