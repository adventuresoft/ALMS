                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6 text-left">
                                    <h3 class="card-title">Road Category List</h3>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a href="{{route('basic-settings.road-category.create')}}" class="btn btn-primary">Create</a>
                                </div>
                                    ...
                                    <tr>
                                      ...
                                      <td style="width:10%">
                                        <div class="table-action">
                                            @can('road-category-update')
<a class="btn btn-sm btn-primary" title="Edit" data-toggle="tooltip" href="{{route('basic-settings.road-category.edit', $item->id)}}"><i class="fa fa-edit"></i></a>
@endcan
