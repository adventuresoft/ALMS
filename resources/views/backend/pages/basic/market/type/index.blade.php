                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6 text-left">
                                    <h3 class="card-title">Market Type List</h3>
                                </div>
                                <div class="col-md-6 text-right">
                                    {{-- {{route('death.create')}} --}}
                                    <a href="{{route('basic-settings.market-type.create')}}" class="btn btn-primary">Create</a>
                                </div>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <div style="display: inline-block">
                                          @can('market-type-update')
<a class="btn btn-primary" href="{{route('basic-settings.market-type.edit', $item->id)}}">Edit</a>
@endcan
                                          @can('market-type-delete')
<form class="deleteCategory" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <input type="hidden" class="id" name="id" value="{{$item->id}}">
                                            <input type="hidden" class="deleteUrl" name="deleteUrl" value="{{route('basic-settings.market-type.destroy', $item->id)}}">
