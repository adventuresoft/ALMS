                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6 text-left">
                                    <h3 class="card-title">Organization Ownership List</h3>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a href="{{route('basic-settings.organization-ownership-type.create')}}" class="btn btn-primary">Create</a>
                                </div>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="table-action">
                                            @can('organization-ownership-type-update')
<a class="btn btn-sm btn-primary" title="Edit" data-toggle="tooltip" href="{{route('basic-settings.organization-ownership-type.edit', $item->id)}}"><i class="fa fa-edit"></i></a>
@endcan
                                            <a class="btn btn-sm btn-info" title="Show" data-toggle="tooltip" href="{{route('basic-settings.organization-ownership-type.show', $item->id)}}"><i class="fa fa-eye"></i></a>

                                            @can('organization-ownership-type-delete')
<form class="deleteType" method="post">
                                              @csrf
                                              @method('DELETE')
                                              <input type="hidden" class="id" name="id" value="{{$item->id}}">
                                              <input type="hidden" class="deleteUrl" name="deleteUrl" value="{{route('basic-settings.organization-ownership-type.destroy', $item->id)}}">
