<aside class="main-sidebar sidebar-dark-primary elevation-4">
 ...
 <li class="nav-item">
                  <a href="{{route('basic-settings.city-corporation.index')}}" class="nav-link @if($subMenu == 'CityCorporation') active @endif">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                  <a href="{{route('basic-settings.union.index')}}" class="nav-link {{$subMenu =='Union'? 'active':''}} ">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Union</p>
                  </a>
                </li>
